...
test('cinema auditorium prompt presets cover special theaters and diagrams', async () => {
  ...
  assert.match(flyingRender, /悬挂式|升降式飞行影院/);
  assert.match(flyingRender, /巨大凹弧形飞行视景屏|半包裹弧幕/);
  assert.match(flyingRender, /装载等候|安全束缚/);
  ...
  assert.match(flyingPlan, /悬挂\/升降飞行座舱阵列/);
  assert.match(flyingPlan, /不得画成普通地面座椅排布/);
  ...
  assert.match(flyingPrinciple, /升降臂|吊挂机构|运动平台/);
