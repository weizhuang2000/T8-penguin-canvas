    ...
    <TooltipAnchor
      ...
      render={
        <a
          href="/"
          aria-label="返回无限画布"
          className="inline-flex h-9 flex-shrink-0 items-center justify-center gap-1.5 rounded-xl border border-border-light bg-presentation px-2.5 text-sm font-medium text-text-primary transition-colors hover:bg-surface-tertiary"
        >
          <ArrowLeft className="icon-md" aria-hidden="true" focusable="false" />
          <span className="hidden md:inline">无限画布</span>
        </a>
      }
    />
  );
