...
const startServer = async () => {
  ...
  // T8 is the sole identity provider for the embedded Codex workspace.
  // The middleware is intentionally global so /api/config and static bootstrap
  // requests receive the same shadow user as protected API routes.
  app.use(require('./middleware/t8BridgeAuth'));
  ...
  // No standalone LibreChat OAuth/login flow is exposed in the T8 deployment.
  app.use('/oauth', require('./middleware/rejectT8StandaloneAuth'));
