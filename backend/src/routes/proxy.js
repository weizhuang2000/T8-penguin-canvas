...
router.post('/image', requireNodePermission(['image', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-creative-image']), async (req, res) => {
  const settings = loadRawSettings();
  const {
...
// ========================================================================
router.post('/image/submit', requireNodePermission(['image', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-creative-image']), async (req, res) => {
  const settings = loadRawSettings();
  try {
...
// 查询异步图像任务状态
router.get('/image/status/:tid', requireNodePermission(['image', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-creative-image']), async (req, res) => {
  const settings = loadRawSettings();
...
router.post('/image/fal/submit', requireNodePermission(['image', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-creative-image']), async (req, res) => {
  const settings = loadRawSettings();
  const {
...
router.post('/image/fal/query', requireNodePermission(['image', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-creative-image']), async (req, res) => {
  const settings = loadRawSettings();
