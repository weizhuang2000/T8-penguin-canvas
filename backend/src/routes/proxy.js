...
router.post('/image', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-lighting-heatmap', 'exhibition-creative-image', 'unit-panel-design', 'showcase-interior-design']), async (req, res) => {
  const settings = loadRawSettings();
  const {
...
// ========================================================================
router.post('/image/submit', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-lighting-heatmap', 'exhibition-creative-image', 'exhibition-render-to-elevation', 'unit-panel-design', 'showcase-interior-design']), async (req, res) => {
  const settings = loadRawSettings();
  try {
...
// 查询异步图像任务状态
router.get('/image/status/:tid', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-lighting-heatmap', 'exhibition-creative-image', 'exhibition-render-to-elevation', 'unit-panel-design', 'showcase-interior-design']), async (req, res) => {
  const settings = loadRawSettings();
...
router.post('/image/fal/submit', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-lighting-heatmap', 'exhibition-creative-image', 'unit-panel-design', 'showcase-interior-design']), async (req, res) => {
  const settings = loadRawSettings();
  const {
...
router.post('/image/fal/query', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-lighting-heatmap', 'exhibition-creative-image', 'unit-panel-design', 'showcase-interior-design']), async (req, res) => {
  const settings = loadRawSettings();
...
router.post('/mj/imagine', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script']), async (req, res) => {
  const settings = loadRawSettings();
  // v1.2.9.15: 一体化「专属优先 fallback 通用」校验
...
// 轮询任务状态
router.get('/mj/task/:id', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script']), async (req, res) => {
  const settings = loadRawSettings();
  // v1.2.9.15: 一体化「专属优先 fallback 通用」校验
  if (!ensureKey(settings, res, 'mj', 'MJ')) return;
...
router.post('/mj/upload', requireNodePermission(['image', 'storyboard-grid', 'interactive-game-script']), async (req, res) => {
  const settings = loadRawSettings();
  // v1.2.9.15: 一体化「专属优先 fallback 通用」校验
  if (!ensureKey(settings, res, 'mj', 'MJ')) return;
