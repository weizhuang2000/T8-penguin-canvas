...
const EXHIBITION_COMPACT_FORM_DEFINITIONS = [
  ...
  { nodeType: 'sculpture-relief-design', label: '\u96d5\u5851/\u6d6e\u96d5\u8bbe\u8ba1', sections: [
    { id: 'source', label: '\u7c7b\u578b\u8bbe\u7f6e', items: [
      { id: 'parameter-input', label: '\u53c2\u6570\u8f93\u5165' },
      { id: 'toggles', label: '\u5f00\u5173\u9009\u9879' },
    ] },
  ...
  { nodeType: 'fusion-render-design', label: '\u878d\u5408\u6548\u679c\u56fe', sections: [
    ...
    { id: 'status', label: '\u8fd0\u884c\u72b6\u6001', items: [{ id: 'main', label: '\u4e3b\u63a7\u4ef6' }] },
    { id: 'result', label: '\u7ed3\u679c\u9884\u89c8', items: [{ id: 'main', label: '\u4e3b\u63a7\u4ef6' }] },
    { id: 'prompt', label: '\u878d\u5408\u7ea6\u675f', items: [{ id: 'main', label: '\u4e3b\u63a7\u4ef6' }] },
  ] },
  { nodeType: 'cinema-auditorium-design', label: '\u5f71\u9662\u62a5\u544a\u5385\u8bbe\u8ba1', sections: [
    ...
    { id: 'layout', label: '\u5ea7\u5e2d\u52a8\u7ebf', items: [{ id: 'slope-mode', label: '\u89c6\u7ebf' }, { id: 'screen-type', label: '\u94f6\u5e55' }, { id: 'main-screen-kind', label: '\u4e3b\u5c4f\u5e55\u79cd\u7c7b' }, { id: 'audio-system', label: '\u58f0\u5b66' }] },
    ...
    { id: 'prompt', label: '\u8865\u5145\u8981\u6c42', items: [{ id: 'text-input', label: '\u6587\u672c\u8f93\u5165' }] },
    { id: 'model', label: '\u6a21\u578b\u53c2\u6570', items: [{ id: 'actions', label: '\u751f\u6210' }, { id: 'provider', label: '\u5e73\u53f0' }, { id: 'model', label: '\u6a21\u578b' }, { id: 'aspect-size', label: '\u6bd4\u4f8b/\u5c3a\u5bf8' }, { id: 'output-format', label: '\u683c\u5f0f' }, { id: 'seed-name', label: 'Seed' }, { id: 'progress', label: '\u8fdb\u5ea6' }] },
    { id: 'result', label: '\u7ed3\u679c\u9884\u89c8', items: [{ id: 'preview', label: '\u9884\u89c8' }, { id: 'outputs', label: '\u8f93\u51fa\u5217\u8868' }] },
  ] },
];
