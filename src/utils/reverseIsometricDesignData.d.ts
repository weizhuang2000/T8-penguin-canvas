...
export interface ReverseIsometricLayoutItem { id: string; url: string; label: string; xRatio: number; yRatio: number; widthRatio: number; heightRatio: number; rotationDeg: number; zIndex: number; }
...
export function buildReverseIsometricPrompt(options?: { viewDirection?: ReverseIsometricDirection; correction?: string }): string;
