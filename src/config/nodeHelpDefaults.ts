...
`,
  ...
  'exhibition-plan-layout': `# 平面自动布局

> 平面图约束 / 大纲提炼 / 动线与标注控制

## 用途
根据建筑平面图和展陈大纲自动生成展陈平面布局图，支持动线、标注和说明文字开关。基于规则算法，结构精确。
...
## 与「平面AI布局」区别
此节点基于规则算法，结构精确但创意性弱。如需 LLM 创意布局，请用「平面AI布局」节点。
`,

  'exhibition-ai-plan-layout': `# 平面AI布局

> AI 读取建筑平面 / 结构锁定 / 展陈布局叠加

## 用途
LLM 读取原始建筑平面图并结合文本大纲生成展陈平面布局，默认锁定原墙体、柱子和门洞结构。基于 AI，创意性强。
...
## 与「平面自动布局」区别
此节点基于 LLM 创意生成，灵活但结构精度依赖模型。如需精确规则布局，请用「平面自动布局」节点。
`,
