...
export const NODE_REGISTRY: NodeMeta[] = [
  ...
  { type: 'image-edit', label: '编辑图片', category: 'utility', description: '接入原始图后打开遮罩、画板编辑窗，保存草稿并输出修改、降噪或重绘结果', icon: 'Edit3', color: 'orange' },
  ...
  { type: 'reverse-isometric-design', label: '反推轴侧', category: 'exhibition', description: '以平面布局约束墙柱、出入口和门窗，手动排布展项并生成无顶展陈轴侧图', icon: 'Boxes', color: 'cyan' },
  { type: 'fusion-render-design', label: '融合效果图', category: 'exhibition', description: '可选平面布局或空白矩形空间，手动排布展项并生成写实展陈空间透视效果图', icon: 'Sparkles', color: 'cyan' },
  ...
  { type: 'seedvr2-upscale', label: 'SeedVR2超分', category: 'core', description: '调用 SeedVR2-7B 对单张上游图像做 AI 超分，支持倍数/目标尺寸、种子、颜色校正和缩放算法', icon: 'ImageUp', color: 'cyan' },
