...
export const RUNNINGHUB_VIDEO_MODELS: RunningHubVideoModelDef[] = [
  ...
  {
    value: 'rhart-video-g/text-to-video',
    label: '全能视频X · 文生视频低价渠道版 v1.5',
    description: '低价渠道版 v1.5 文生视频；支持 480p/720p 与 6-30 秒。',
    mode: 'text',
    ratios: ['2:3', '3:2', '1:1', '16:9', '9:16'],
    defaultRatio: '16:9',
    durations: Array.from({ length: 25 }, (_, index) => index + 6),
  ...
  {
    value: 'rhart-video-g-official/image-to-video',
    label: '全能视频X · 图生视频官方稳定版',
    description: '官方稳定图生视频；支持 480p/720p 与 6/10 秒。',
    mode: 'image',
    ratios: [],
    defaultRatio: '',
    durations: [6, 10],
  ...
  {
    value: 'rhart-video-g-official/image-to-video-v1.5',
    label: '全能视频X · 图生视频官方稳定版 v1.5',
    description: '官方稳定 v1.5 图生视频；支持 480p/720p 与 1-15 秒。',
    mode: 'image',
    ratios: [],
    defaultRatio: '',
  ...
  {
    value: 'rhart-video-g-official/reference-to-video',
    label: '全能视频X · 多图参考生视频官方稳定版',
    description: '官方稳定多图参考视频；支持 1-7 张参考图、480p/720p 与 6/10 秒。',
    mode: 'image',
    ratios: [],
    defaultRatio: '',
    durations: [6, 10],
  ...
  {
    value: 'rhart-video-g-official/edit-video',
    label: '全能视频X · 编辑视频官方稳定版',
    description: '官方稳定视频编辑；需 1 个不超过 50MB 的参考视频，支持 480p/720p。',
    mode: 'video',
    ratios: [],
    defaultRatio: '',
    durations: [],
  ...
  {
    value: 'rhart-video-g-official/text-to-video',
    label: '全能视频X · 文生视频官方稳定版',
    description: '官方稳定文生视频；支持 480p/720p、6/10 秒与横竖屏/方形画幅。',
    mode: 'text',
  ...
  {
    value: 'rhart-video-g-official/video-extend',
    label: '全能视频X · 视频续写官方稳定版',
    description: '官方稳定视频续写；需 1 个不超过 100MB 的参考视频，支持续写 6/10 秒。',
    mode: 'video',
    ratios: [],
    defaultRatio: '',
    durations: [6, 10],
  ...
  {
    value: 'rhart-video-v3.1-fast/text-to-video',
    label: '全能视频V3.1-fast · 文生视频低价渠道版',
    description: 'V3.1 高性价比速享版文生视频；固定 8 秒，支持原生音画同步与 720p/1080p/4k。',
    mode: 'text',
    ratios: ['16:9', '9:16'],
    defaultRatio: '9:16',
    durations: [8],
