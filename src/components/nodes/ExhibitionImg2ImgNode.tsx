...
const ExhibitionImg2ImgNode = ({ id, data, selected }: NodeProps) => {
  ...
  return (
    <div
      data-exhibition-compact-node-type="exhibition-img2img"
    ...
    >
      ...
      <div className="nodrag nopan max-h-[780px] space-y-2 overflow-y-auto p-2.5" onMouseDown={(event) => event.stopPropagation()}>
        ...
        <section data-exhibition-compact-section="exclusions" className="space-y-1.5 rounded border border-white/10 bg-white/[0.035] p-2">
          <div className="flex items-center gap-2">
        ...
        <section data-exhibition-compact-section="content" className="rounded border border-white/10 bg-white/[0.035] p-2">
          <div className="mb-1.5 flex items-center gap-2">
