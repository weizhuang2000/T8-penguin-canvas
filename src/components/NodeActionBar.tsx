...
const EXECUTABLE_NODE_TYPES = new Set<string>([
  ...
  'elevation-prompt', 'exhibition-img2img', 'exhibition-style-transfer', 'exhibition-recolor', 'exhibition-lighting-heatmap', 'exhibition-creative-image', 'exhibition-outline-split', 'exhibition-plan-layout', 'unit-panel-design', 'showcase-interior-design',
